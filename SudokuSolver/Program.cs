namespace brinux.sudokuSolver
{
	class Program
	{
		static void Main(string[] args)
		{
            ...
            sudoku.Set(new int[][]
            {
                new int[9] { 0, 0, 0, 0, 8, 0, 0, 0, 5 },
                new int[9] { 8, 3, 1, 0, 0, 2, 0, 0, 0 },
                new int[9] { 0, 0, 5, 7, 0, 4, 0, 0, 0 },
                new int[9] { 2, 4, 0, 0, 7, 0, 0, 0, 0 },
                new int[9] { 0, 0, 0, 4, 0, 8, 0, 0, 0 },
                new int[9] { 0, 0, 0, 0, 5, 0, 0, 4, 9 },
                new int[9] { 0, 0, 0, 8, 0, 5, 3, 0, 0 },
                new int[9] { 0, 0, 0, 6, 0, 0, 1, 2, 4 },
                new int[9] { 9, 0, 0, 0, 4, 0, 0, 0, 0 }
            });
            /*
			sudoku.Set(new int[][]
			{
